...
namespace ScintillaMod {
    ...
    static void
    ColouriseESCRIPTDoc(Sci_PositionU startPos, Sci_Position length, int initStyle, WordList *keywordlists[],
                        Accessor &styler) {
...
//				sc.GetCurrentLowered(s, sizeof(s));
    ...
    static void
    FoldESCRIPTDoc(Sci_PositionU startPos, Sci_Position length, int initStyle, WordList *[], Accessor &styler) {
