...
namespace ScintillaMod {
    ...
    static void
    ClassifyWordSol(Sci_PositionU start, Sci_PositionU end, WordList &keywords, Accessor &styler, char *prevWord) {
        char s[100] = "";
        ...
        if (0 == strcmp(prevWord, "class")) chAttr = SCE_SCRIPTOL_CLASSNAME;
            ...
            for (Sci_PositionU i = 0; i < end - start + 1; i++)  // test dotted idents
            {
                if (styler[start + i] == '.') {
