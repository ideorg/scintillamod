...
namespace ScintillaMod {
    ...
    static void
    ColouriseSpecmanDoc(Sci_PositionU startPos, Sci_Position length, int initStyle, WordList *keywordlists[],
...
// and to make it possible to fiddle the current level for "} else {".
    ...
    static void
    ColouriseSpecmanDocSensitive(Sci_PositionU startPos, Sci_Position length, int initStyle, WordList *keywordlists[],
                                 Accessor &styler) {
