...
/***************************************/
    static void
    CheckBackComLines(Accessor &styler, bool isFixFormat, Sci_Position lineCurrent, const unsigned int nComL,
                      Sci_Position nComColB[], Sci_Position nComColF[], Sci_Position nComCur,
                      bool comLineB[], bool comLineF[], bool &comLineCur) {
            ...
            if (style == SCE_F_WORD) {
                if (iswordchar(ch) && !iswordchar(chNext)) {
                    ...
                    if (strcmp(s, "forall") == 0 || (strcmp(s, "where") == 0 && strcmp(prevWord, "else") != 0)) {
                        ...
                        } else if ((strcmp(prevWord, "select") == 0 && strcmp(s, "case") == 0) ||
                                   strcmp(s, "selectcase") == 0 ||
                                   (strcmp(prevWord, "select") == 0 && strcmp(s, "type") == 0) ||
                                   strcmp(s, "selecttype") == 0) {
                            levelDeltaNext += 2;
...
/***************************************/
    static void
    ColouriseFortranDocFreeFormat(Sci_PositionU startPos, Sci_Position length, int initStyle, WordList *keywordlists[],
                                  Accessor &styler) {
...
/***************************************/
    static void
    ColouriseFortranDocFixFormat(Sci_PositionU startPos, Sci_Position length, int initStyle, WordList *keywordlists[],
                                 Accessor &styler) {
...
/***************************************/
    LexerModule lmFortran(SCLEX_FORTRAN, ColouriseFortranDocFreeFormat, "fortran", FoldFortranDocFreeFormat,
                          FortranWordLists);
