...
// Find length of CMD FOR variable with modifier (%~...) or return 0
    ...
    static void
    ColouriseTCMDLine(char *lineBuffer, Sci_PositionU lengthLine, Sci_PositionU startLine, Sci_PositionU endPos,
...
//	WordList &keywords2 = *keywordlists[1];     // Aliases (optional)
        ...
        if (lineBuffer[offset] == ':') {
            ...
            // Check for Comment - return if found
                   ...
                   ((lineBuffer[offset + 3] == 0) || (isspace(lineBuffer[offset + 3])))) {
            styler.ColourTo(endPos, SCE_TCMD_COMMENT);
            return;
        ...
        while (offset < lengthLine) {
            ...
            if (IsBSeparator(wordBuffer[0])) {
            ...
            } else if ((wordBuffer[0] != '%') && (wordBuffer[0] != '!') && (!IsBOperator(wordBuffer[0])) &&
                       (!inString) && (continueProcessing)) {
                ...
                if (!sKeywordFound) {
                    ...
                    while ((wbo < wbl) && (wordBuffer[wbo] != '%') && (!isDelayedExpansion || wordBuffer[wbo] != '!') &&
    ...
    static void
    ColouriseTCMDDoc(Sci_PositionU startPos, Sci_Position length, int /*initStyle*/, WordList *keywordlists[],
                     Accessor &styler) {
    ...
    static void FoldTCMDDoc(Sci_PositionU startPos, Sci_Position length, int, WordList *[], Accessor &styler) {
        ...
        for (Sci_PositionU i = startPos; i < endPos; i++) {
            ...
            if ((bLineStart) && (style == SCE_TCMD_WORD)) {
                ...
                StrUpr(s);
                if ((strcmp(s, "DO") == 0) || (strcmp(s, "IFF") == 0) || (strcmp(s, "SWITCH") == 0) ||
                    (strcmp(s, "TEXT") == 0)) {
                    levelIndent++;
                } else if ((strcmp(s, "ENDDO") == 0) || (strcmp(s, "ENDIFF") == 0) || (strcmp(s, "ENDSWITCH") == 0) ||
                           (strcmp(s, "ENDTEXT") == 0)) {
                    levelIndent--;
                }
            }
